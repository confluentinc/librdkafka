...
describe('DekRegistryClient', () => {
  ...
  beforeEach(() => {
    ...
    client = new DekRegistryClient(restService);
  });
  ...
  it('Should register kek when registerKek is called', async () => {
    restService.sendHttpRequest.mockResolvedValue({ data: TEST_KEK } as AxiosResponse);
  ...
  it('Should return kek from cache when registerKek is called with same kek name', async () => {
    ...
    restService.sendHttpRequest.mockResolvedValue({ data: TEST_KEK_2 } as AxiosResponse);
  ...
  it('Should register dek when registerDek is called', async () => {
    restService.sendHttpRequest.mockResolvedValue({ data: TEST_DEK } as AxiosResponse);
  ...
  it('Should return dek from cache when registerDek is called with same kek name, subject, algorithm, and version', async () => {
    ...
    restService.sendHttpRequest.mockResolvedValue({ data: TEST_DEK_2 } as AxiosResponse);
  ...
  restService.sendHttpRequest.mockResolvedValue({ data: TEST_DEK_LATEST } as AxiosResponse);
