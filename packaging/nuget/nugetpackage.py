...
class NugetPackage (Package):
    ...
    mappings = [
        ...
        Mapping({'arch': 'arm64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v142/ARM64/Release/librdkafka.dll',
                'runtimes/win-arm64/native/librdkafka.dll'),
        Mapping({'arch': 'arm64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v142/ARM64/Release/librdkafkacpp.dll',
                'runtimes/win-arm64/native/librdkafkacpp.dll'),
        Mapping({'arch': 'arm64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v142/ARM64/Release/libcrypto-3-arm64.dll',
                'runtimes/win-arm64/native/libcrypto-3-arm64.dll'),
        Mapping({'arch': 'arm64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v142/ARM64/Release/libssl-3-arm64.dll',
                'runtimes/win-arm64/native/libssl-3-arm64.dll'),
        Mapping({'arch': 'arm64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v142/ARM64/Release/zlib1.dll',
                'runtimes/win-arm64/native/zlib1.dll'),
        Mapping({'arch': 'arm64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v142/ARM64/Release/zstd.dll',
                'runtimes/win-arm64/native/zstd.dll'),
        Mapping({'arch': 'arm64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v142/ARM64/Release/libcurl.dll',
                'runtimes/win-arm64/native/libcurl.dll'),
        # matches ARM64 librdkafka.redist.zip, lib files
        Mapping({'arch': 'arm64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/lib/v142/ARM64/Release/librdkafka.lib',
                'build/native/lib/win/arm64/win-arm64-Release/v142/librdkafka.lib'  # noqa: E501
                ),
        Mapping({'arch': 'arm64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/lib/v142/ARM64/Release/librdkafkacpp.lib',
                'build/native/lib/win/arm64/win-arm64-Release/v142/librdkafkacpp.lib'  # noqa: E501
                )
    ]
