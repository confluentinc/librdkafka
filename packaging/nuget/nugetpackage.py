...
class NugetPackage (Package):
    ...
    mappings = [
        ...
        Mapping({'arch': 'x64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v145/x64/Release/librdkafka.dll',
                'runtimes/win-x64/native/librdkafka.dll'),
        Mapping({'arch': 'x64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v145/x64/Release/librdkafkacpp.dll',
                'runtimes/win-x64/native/librdkafkacpp.dll'),
        Mapping({'arch': 'x64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v145/x64/Release/libcrypto-3-x64.dll',
                'runtimes/win-x64/native/libcrypto-3-x64.dll'),
        Mapping({'arch': 'x64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v145/x64/Release/libssl-3-x64.dll',
                'runtimes/win-x64/native/libssl-3-x64.dll'),
        Mapping({'arch': 'x64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v145/x64/Release/zlib1.dll',
                'runtimes/win-x64/native/zlib1.dll'),
        Mapping({'arch': 'x64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v145/x64/Release/zstd.dll',
     ...
     v145       'librdkafka.redist*',
        ...
        Mapping({'arch': 'x64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/lib/v145/x64/Release/librdkafka.lib',
                'build/native/lib/win/x64/win-x64-Release/v145/librdkafka.lib'  # noqa: E501
                ),
        Mapping({'arch': 'x64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/lib/v145/x64/Release/librdkafkacpp.lib',
                'build/native/lib/win/x64/win-x64-Release/v145/librdkafkacpp.lib'  # noqa: E501
                ),
        ...
        Mapping({'arch': 'x86',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v145/Win32/Release/librdkafka.dll',
                'runtimes/win-x86/native/librdkafka.dll'),
        Mapping({'arch': 'x86',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v145/Win32/Release/librdkafkacpp.dll',
                'runtimes/win-x86/native/librdkafkacpp.dll'),
        Mapping({'arch': 'x86',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v145/Win32/Release/libcrypto-3.dll',
                'runtimes/win-x86/native/libcrypto-3.dll'),
        Mapping({'arch': 'x86',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v145/Win32/Release/libssl-3.dll',
                'runtimes/win-x86/native/libssl-3.dll'),

        Mapping({'arch': 'x86',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v145/Win32/Release/zlib1.dll',
                'runtimes/win-x86/native/zlib1.dll'),
        Mapping({'arch': 'x86',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v145/Win32/Release/zstd.dll',
                'runtimes/win-x86/native/zstd.dll'),
        Mapping({'arch': 'x86',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v145/Win32/Release/libcurl.dll',
        ...
        Mapping({'arch': 'x86',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/lib/v145/Win32/Release/librdkafka.lib',
                'build/native/lib/win/x86/win-x86-Release/v145/librdkafka.lib'  # noqa: E501
                ),
        Mapping({'arch': 'x86',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/lib/v145/Win32/Release/librdkafkacpp.lib',
                'build/native/lib/win/x86/win-x86-Release/v145/librdkafkacpp.lib'  # noqa: E501
                ),

        # Common Win arm64 runtime
        Mapping({'arch': 'arm64',
                 'plat': 'win'},
                'msvcr140.zip',
                'vcruntime140.dll',
        ...
        Mapping({'arch': 'arm64',
                 'plat': 'win'},
                'msvcr140.zip',
                'msvcp140.dll', 'runtimes/win-arm64/native/msvcp140.dll'),

        # matches ARM64 librdkafka.redist.zip
        Mapping({'arch': 'arm64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v145/ARM64/Release/librdkafka.dll',
                'runtimes/win-arm64/native/librdkafka.dll'),
        Mapping({'arch': 'arm64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v145/ARM64/Release/librdkafkacpp.dll',
                'runtimes/win-arm64/native/librdkafkacpp.dll'),
        Mapping({'arch': 'arm64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v145/ARM64/Release/libcrypto-3-arm64.dll',
                'runtimes/win-arm64/native/libcrypto-3-arm64.dll'),
        Mapping({'arch': 'arm64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v145/ARM64/Release/libssl-3-arm64.dll',
                'runtimes/win-arm64/native/libssl-3-arm64.dll'),
        Mapping({'arch': 'arm64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v145/ARM64/Release/zlib1.dll',
                'runtimes/win-arm64/native/zlib1.dll'),
        Mapping({'arch': 'arm64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v145/ARM64/Release/zstd.dll',
                'runtimes/win-arm64/native/zstd.dll'),
        Mapping({'arch': 'arm64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/bin/v145/ARM64/Release/libcurl.dll',
                'runtimes/win-arm64/native/libcurl.dll'),
        # matches ARM64 librdkafka.redist.zip, lib files
        Mapping({'arch': 'arm64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/lib/v145/ARM64/Release/librdkafka.lib',
                'build/native/lib/win/arm64/win-arm64-Release/v145/librdkafka.lib'  # noqa: E501
                ),
        Mapping({'arch': 'arm64',
                 'plat': 'win'},
                'librdkafka.redist*',
                'build/native/lib/v145/ARM64/Release/librdkafkacpp.lib',
                'build/native/lib/win/arm64/win-arm64-Release/v145/librdkafkacpp.lib'  # noqa: E501
                )
    ]
