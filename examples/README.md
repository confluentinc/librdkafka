 ...
 * [producer_schema_registry.cpp](producer_schema_registry.cpp) - producer using
                                      Schema Registry, via libschemaregistry and
                                      avro-cpp. Not built by `make`; see the
                                      file header for its extra build
                                      dependencies.
