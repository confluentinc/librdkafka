...
broker.thread.count                      |  *  | 1 .. 1000       |             1 | Broker threads to be run. Should be set to a value less than (starting at 1) or equal to the number of brokers as appropriate for the workload. <br>*Type: integer*
